...
if __name__ == '__main__':
    ...
    decision = 'y' #input('Continue? Y/N ')
    # pass the decision part
    ...
    # for i in range(3):
        ...
        mask_path = os.path.join(r_slide_save_dir, '{}_mask.png'.format(slide_id))
        ...
        features_path = os.path.join('/home1/qiuliwang/Code/CLAM_wql_version/Features/tumor_vs_normal_resnet_features/pt_files', slide_id+'.pt')
        h5_path = os.path.join('/home1/qiuliwang/Code/CLAM_wql_version/Features/tumor_vs_normal_resnet_features/h5_files', slide_id+'.h5')
        ...
        os.makedirs('selected_patch/results/', exist_ok=True)
        if data_args.process_list is not None:
            process_stack.to_csv('selected_patch/results/{}.csv'.format(data_args.process_list.replace('.csv', '')), index=False)
        else:
            process_stack.to_csv('selected_patch/results/{}.csv'.format(exp_args.save_exp_code), index=False)
